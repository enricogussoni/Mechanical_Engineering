...
% Control on max length of the element
fmax = 5; % [Hz]
Ommax = 2*pi*fmax;
ml= 6600;
mt = 12000;
...
[file_i,xy,nnod,sizee,idb,ndof,incidenze,l,gamma,m,EA,EJ,posiz,nbeam]=MeccFEM2_loadstructure('TE10072015')

MeccFEM2_plotStructure(posiz,xy)
